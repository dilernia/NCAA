---
title: "🏀 March Madness Dashboard 2024 🏀"
output:
...
setwd(paste0("H:/My Drive/dilerand@mail.gvsu.edu 2022-11-21 21 19/Other/Fun/March Madness/", tourney_year))
...
draw_bracket <- function(submission, seeds, teams, logo = NULL, lineColor = "black", 
...
team_logos <- list.files("../team_logos_images/", include.dirs = TRUE)
```
...
round_reactable_fun <- function(myData, gradColors = color_gradient, ndigits = 1) {
  myData |> 
  reactable(showSortIcon = FALSE,
          searchable = TRUE,
...
# Function for creating reactable table
# Following example at: https://kcuilla.github.io/reactablefmtr/articles/themes.html
reactableFun <- function(myData, gradColors = color_gradient) {
  myData |> 
  reactable(showSortIcon = FALSE,
          searchable = TRUE,
          filterable = TRUE,
...
reactableFun(myData = bracket_res_mens$ret |> 
               drop_na())
```
...
```{r, eval = TRUE, include = TRUE}
# Following example at: https://kcuilla.github.io/reactablefmtr/articles/themes.html
reactableFun(myData = bracket_res_womens$ret |> 
               drop_na())
```
